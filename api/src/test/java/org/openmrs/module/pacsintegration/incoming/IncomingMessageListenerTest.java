...
public class IncomingMessageListenerTest extends BaseModuleContextSensitiveTest {
    ...
    private TestTaskRunner ormO01TaskRunner;
    private TestTaskRunner oruR01TaskRunner;
    ...
    public void setup() throws Exception {
        ...
        ormO01TaskRunner = new TestTaskRunner("ORM_O01");
        oruR01TaskRunner = new TestTaskRunner("ORU_R01");
        orm_o01Handler.setTaskRunner(ormO01TaskRunner);
        oru_r01Handler.setTaskRunner(oruR01TaskRunner);
    }
    ...
    public void shouldReceiveORU_RO1MessageAndRouteToHandler() throws Exception  {
        ...
        Thread.sleep(2000);
        Assertions.assertNull(ormO01TaskRunner.getTask());
        Assertions.assertNotNull(oruR01TaskRunner.getTask());
        Assertions.assertEquals("ORU_R01", oruR01TaskRunner.getIdentifier());
    }
    ...
    public void shouldReceiveORM_OO1MessageAndRouteToHandler() throws Exception  {
        ...
        Thread.sleep(2000);
        Assertions.assertNull(oruR01TaskRunner.getTask());
        Assertions.assertNotNull(ormO01TaskRunner.getTask());
        Assertions.assertEquals("ORM_O01", ormO01TaskRunner.getIdentifier());
    }
